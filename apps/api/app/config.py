...
class Settings(BaseSettings):
    ...
    fe_cloudfront_bucket: str = ""
    fe_cloudfront_prefix: str = ""
    fe_akamai_bucket: str = ""
    fe_akamai_prefix: str = ""
    remote_max_objects: int = 5_000
    remote_max_total_bytes: int = 20_000_000_000
